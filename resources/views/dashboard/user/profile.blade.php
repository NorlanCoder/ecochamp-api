                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    <img src="{{asset($profile->url_profil ?? 'assets/images/profile.png')}}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
                                    <div class="mt-3">
                                        <h4>{{$profile->fullname}}</h4>
                                        <p class="text-secondary mb-1">{{$profile->email}}</p>
                                        <p class="text-muted font-size-sm">{{$profile->phone_number}}</p>
                                        <p class="text-muted font-size-sm">{{ $profile->address ?? $profile->country . ', ' . $profile->city }}</p>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="d-flex align-items-center mb-3">Profile Account</h5>
                                        <p>Alerte Post</p>

            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">ONG</li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="card-title">
                    <h5 class="mb-0">Listes des ONG</h5>
                </div>
                <hr/>
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            @foreach($ongs as $item)
                                <tr>
                                    <td>
                                        <img class="img-profile rounded-circle img-fluid" src="{{asset($item->url_profil)}}" alt="profile" style="max-width: 50px; max-height: 50px;">
                                    </td>
                                    <td>{{$item->fullname}}</td>
                                    <td>{{$item->email}}</td>
                                    <td>
